...
//include "CesiumGeospatial/GlobeAnchorComponent.h"
...
void AFlyingPawn::BeginPlay()
{
    ...
    longitude =0.0;
    altitude = 0.0;
	clientSocket.buildSocket(LOCAL_TCP_CLIENT, 58562);
...
void AFlyingPawn::Tick(float DeltaSeconds)
{
    ...
    FString locationString = FString::Printf(TEXT("Latitude: %f, Longitude: %f, Altitude: %f, heading: %f"), latitude, longitude, altitude, heading);

    // Send the location data to the socket
    clientSocket.writeSocket(TCHAR_TO_UTF8(*locationString));
}
