...
public:
	...
	rfrlToolkit::rfrlSocket clientSocket;

    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "location")
    double latitude ; 
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "location")// Replace with actual conversion logic
    double longitude ;    
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "location")// Replace with actual conversion logic
    double altitude ; // Replace with actual conversion logic
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "location")// Replace with actual conversion logic
    double heading ; 
    // Format the string
    AFlyingPawn();
